...
ALTER TYPE "Category" ADD VALUE 'DATA_SCIENCE';
ALTER TYPE "Category" ADD VALUE 'CYBERSECURITY';
...
-- AlterTable
ALTER TABLE "Post" ADD COLUMN     "githubLink" TEXT,
