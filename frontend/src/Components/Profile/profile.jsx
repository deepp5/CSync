...
const ProfilePage = () => {
  ...
  const followersCount = (Array.isArray(followers) ? followers.length : 0) ?? 0;
  const followingCount = (Array.isArray(following) ? following.length : 0) ?? 0;
    ...
    <>
      ...
      <div className="ml-[230px] lg:data-[sidebar=false]:ml-[70px] max-[768px]:ml-0 transition-all duration-300 min-h-screen bg-[#14141E] text-white pt-0 max-[768px]:">
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-8">
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6">
              ...
              <div className="flex-1 text-center lg:text-left min-w-0">
                ...
                {isEditingHeader ? (
                  <input
                    className="w-full max-w-md px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-cyan-400 transition-colors text-sm mb-3"
                ...
                {isEditingHeader ? (
                  <div className="mt-3 mb-4 space-y-3 max-w-2xl">
                    ...
                    <div className="flex items-center justify-center lg:justify-start gap-4 mb-4">
                      {profile.githubUrl && (
                        <a
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-cyan-400/50 rounded-lg transition-all text-sm group"
                        >
                          <FiGithub className="text-cyan-400 group-hover:scale-110 transition-transform" />
                          <span className="text-white/70 group-hover:text-white">GitHub</span>
                        </a>
                      )}
                      {profile.linkedinUrl && (
                        <a
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-cyan-400/50 rounded-lg transition-all text-sm group"
                        >
                          <FiLinkedin className="text-cyan-400 group-hover:scale-110 transition-transform" />
        ...
        <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
          {/* Bio Card */}
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-colors relative">
            {isOwnProfile && !isEditingAbout && (
              <button
                onClick={startEditAbout}
                className="absolute top-4 right-4 p-2 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-cyan-400/60 rounded-lg transition-all hover:scale-110"
            ...
            {isEditingAbout ? (
              <>
                <textarea
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-cyan-400 transition-colors resize-none mb-4"
                  value={editForm.bio}
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-colors relative">
            ...
            {isEditingSkills ? (
              <>
                <input
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-cyan-400 transition-colors mb-4"
                  value={skillsInput}
